export local_path="/mnt/home/baclark/IceCube/new_ehe/new/radio_metaproject/src/icetradio"
export PYTHONPATH=$local_path/extern/NuRadioMC:$PYTHONPATH
export PYTHONPATH=$local_path/extern/NuRadioReco:$PYTHONPATH
export PYTHONPATH=$local_path/extern/radiotools:$PYTHONPATH
export icetradio_path=$local_path
